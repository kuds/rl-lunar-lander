...
# NB: we have two Q networks to solve the problem of overestimation of Q-Values, we use the minimun of the two networks to do out policy and V function updates
...
# The target for the Q training depends on the V network and the target for the V training depends on the Q training. This makes training very unstable
# The solution is to use a set of parameters which come close to the parameters of the main V network but with a time delay
